...
// Frontend-compatible logging - using console instead of @cvplus/logging
const logger = {
  logError: (message: string, error: Error, data?: any) => console.error(message, error, data),
  logDebug: (message: string, data?: any) => console.debug(message, data),
  logInfo: (message: string, data?: any) => console.info(message, data),
  logWarning: (message: string, data?: any) => console.warn(message, data),
  logCritical: (message: string, error: Error, data?: any) => console.error('[CRITICAL]', message, error, data),
};
